...
mysqldump -umonster -pytrip123123 --databases tinytopic > $BACKUP_PATH/tinytopic.sql
...
tar zcf $BACKUP_PATH/tinytopic_db_$DATE_NAME.tar.gz $BACKUP_PATH/tinytopic.sql
...
echo "tinytopic.com db backup" | mutt -a $BACKUP_PATH/tinytopic_db_$DATE_NAME.tar.gz -s "tinytopic.com db backup" -c huacnlee@gmail.com
